...
class HumanPlayer(Player):
    def move(self):
        response = valid_input("Rock, paper, or scissors? Choose your move.\n> ",
                               "rock", "paper", "scissors")
        return response
...
class Game:
    ...
    def play_round(self):
        move1 = self.p1.move()
        move2 = self.p2.move()
        print(f"\nPlayer 1 = YOU: {move1}  Player 2 = Computer: {move2}")
        ...
        while True:
            if move1 == move2:
                ...
                print("Computer wins! Player 2 wins!\n")
                self.p2.count += 1
    ...
    def play_game(self):
        self.p1.count = 0
        self.p2.count = 0
        print("\nReady to play rock, paper, scissors? Let's go!\n")
    ...
    def play_again(self):
        ...
        if "yes" in response:
            ...
            print("\nThat was fun! Thank you for playing!\n")
            exit()
